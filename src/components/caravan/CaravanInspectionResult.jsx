...
export default function CaravanInspectionResult({ inspectionResult }) {
  return (
    <div>
                      ...
                      <div>
                        ...
                        {tableEntries.map(([key, value]) => (
                          <div key={key} className={styles.row}>
                            {caravanPresetParts.includes(key) ? (
                              <PresetCommentComponent k={key} value={value} />
                            ) : caravanLightParts.includes(key) ? (
                              <LightComponent k={key} value={value} />
                            ) : caravanYesNoParts.includes(key) ? (
